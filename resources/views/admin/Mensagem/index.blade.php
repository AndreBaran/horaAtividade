...
@include('admin.mensagem.modal-mensagem')
  ...
  <br>
        ...
        <tbody>
          @foreach($registros as $registro)
            <tr>
              ...
              <td>{{$registro->end}}</td>
              <td>{{$registro->professor_id}}</td>
              <td>{{$registro->tipoatividade_id}}</td>
    ...
    <div class="row">
      <a class="btn btn-outline-success" href="{{ route('admin.mensagem.adicionar') }}">Adicionar</a>

    </div>
    <div class="box">
      <button id="mensagem" type="button"  class="btn btn-sm btn-outline-secondary" justify-content: flex-end  onclick="openModal_msg('modalMensagem','')">Buscar</button>
    </div>
